...
func NewDeployment(c *fiber.Ctx) error {
	...
	if meta, err = dbconn.Collection.CreateDocument(ctx, deployment); err != nil && !driver.IsConflict(err) {
...
// @description ![license](https://img.shields.io/github/license/ortelius/scec-deployment)
// @description
